...
namespace DrumStats.Controls
{
    ...
    public class GridView : Grid
    {
        ...
        public static readonly BindableProperty TileHeightProperty = BindableProperty.Create(nameof(TileHeight), typeof(GridLength), typeof(GridView), GridLength.Auto);
        ...
        {
            get { return (GridLength)GetValue(TileHeightProperty); }
